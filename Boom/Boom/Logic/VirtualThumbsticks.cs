...
namespace Boom.Logic
{
    ...
    public static class VirtualThumbsticks
    {
        ...
        private const float MAX_THUMBSTICK_DISTANCE = 60f;
        ...
        public static Vector2 LeftThumbstick
        {
            get
            {
                ...
                Vector2 l = (leftPosition - LeftThumbstickCenter.Value) / MAX_THUMBSTICK_DISTANCE;
        ...
        public static Vector2 RightThumbstick
        {
            get
            {
                ...
                // calculate the scaled vector from the touch position to the center,
                // scaled by the maximum thumbstick distance
                Vector2 r = (rightPosition - RightThumbstickCenter.Value) / MAX_THUMBSTICK_DISTANCE;
